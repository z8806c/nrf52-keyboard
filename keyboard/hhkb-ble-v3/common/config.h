...
#define VENDOR_ID 0x0106 /* USB VID */
#define PRODUCT_ID 0x0729 /* USB PID */
#define CONF_VENDOR_ID 0x0106 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0729 /* 配置项目内显示的ProductID */
#define MANUFACTURER "HTKB" /* 硬件制造商，用于蓝牙显示 */

#define PRODUCT "HTKB HHKB-BLE" /* 硬件名称，用于蓝牙显示 */
