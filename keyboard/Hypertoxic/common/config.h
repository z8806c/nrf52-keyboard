...
#define VENDOR_ID 0x1206 /* USB VID */
#define PRODUCT_ID 0x0620 /* USB PID */
#define CONF_VENDOR_ID 0x1206 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0620 /* 配置项目内显示的ProductID */
